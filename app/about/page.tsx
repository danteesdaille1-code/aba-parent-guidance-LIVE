...
export default function AboutPage() {
  return (
    <div className="min-h-screen">
      {/* Page Header */}
      <section className="bg-gradient-pastel text-white py-12">
        <div className="max-w-5xl mx-auto px-4 text-center">
          <h1 className="text-4xl sm:text-5xl font-bold mb-4">
            About ABA Parent Guidance
          </h1>
          <p className="text-lg sm:text-xl opacity-90 max-w-3xl mx-auto">
            Evidence-based strategies and personalized guidance to help your child learn and grow
          </p>
        </div>
      </section>

      {/* How It Works */}
      <section className="py-16 bg-warm-surface dark:bg-dark-bg">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl sm:text-4xl font-bold text-textDark dark:text-dark-text-primary text-center mb-12">
            How It Works
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-textDark dark:text-dark-text-primary mb-3">
                Take the Assessment
              </h3>
      ...
      {/* Features */}
      <section className="py-16 bg-background dark:bg-dark-surface">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl sm:text-4xl font-bold text-textDark dark:text-dark-text-primary text-center mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card>
              <div className="text-center">
                ...
                <h3 className="text-lg font-bold text-textDark dark:text-dark-text-primary mb-2">
                  Skills Assessment
                </h3>
      ...
      <section className="py-16 bg-warm-surface dark:bg-dark-bg">
        <div className="max-w-4xl mx-auto px-4">
          <div className="bg-warm-subtle dark:bg-dark-card rounded-lg p-8 border-2 border-primary dark:border-primary-light">
            <h2 className="text-2xl sm:text-3xl font-bold text-textDark dark:text-dark-text-primary mb-4">
              What is ABA?
            </h2>
            ...
            <ul className="space-y-2 text-gray-700 dark:text-dark-text-secondary mb-4">
      ...
      <section className="py-16 bg-gradient-to-br from-success to-green-700 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <Link href="/assessment">
            <Button size="lg" className="bg-warm-surface text-textDark dark:text-dark-text-primary hover:bg-warm-elevated text-lg px-8">
      ...
      <section className="py-16 bg-warm-surface dark:bg-dark-bg">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-textDark dark:text-dark-text-primary text-center mb-12">
            Who This App Is For
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="bg-green-50 dark:bg-dark-card border-2 border-success dark:border-success-light">
              <h3 className="text-xl font-bold text-textDark dark:text-dark-text-primary mb-3 flex items-center gap-2">
            ...
            <Card className="bg-yellow-50 dark:bg-dark-card border-2 border-yellow-400 dark:border-yellow-500">
              <h3 className="text-xl font-bold text-textDark dark:text-dark-text-primary mb-3 flex items-center gap-2">
              ...
              <ul className="space-y-2 text-gray-700 dark:text-dark-text-secondary text-sm">
              ...
              <p className="text-gray-700 dark:text-dark-text-secondary mt-3 text-sm">
